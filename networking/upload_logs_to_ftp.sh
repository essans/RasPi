...
current_sysinfo_dump=`ls -ltr /home/pi/log/$uname"_sysinfodump.log"`
...
if [ "$prev_sysinfo_dump"  != "$current_sysinfo_dump" ]; then
        curl -T /home/pi/log/$uname"_sysinfodump.log" -u $USER:$PASSWORD ftp://ftp.raspi.soobratty.com/
        ls -ltr /home/pi/log/$uname"_sysinfodump.log" > $uname"_sysinfodump.ftp"
fi
